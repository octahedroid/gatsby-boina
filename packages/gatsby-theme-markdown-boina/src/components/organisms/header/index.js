      ...
      ? (
        <div className="c-header__normal cell grid-container align-right grid-x">
          <div className="cell grid-x small-12 medium-9 large-7 xlarge-6 xxlarge-6 align-right grid-x">
            ...
            <div className={`cell small-6 medium-4 grid-x align-center ${darkMenu ? 'c-header__menu--dark' : ''}`}><a className="c-header__menu-link c-header__menu-link--cta" href="#" target="_blank" rel="noopener noreferrer">Some CTA</a></div>
          </div>
        </div>
      )
      : (
