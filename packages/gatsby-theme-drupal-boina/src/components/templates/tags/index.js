...
class TagsPage extends Component {
  ...
  loadItems = (page) => {
    ...
    this.setState({
      ...
      hasMoreItems:
        this.props.data.allNodeArticle.edges.length >= 6 * page + 1
          ? true
          : false,
    })
  }
  ...
  render() {
    ...
    return (
      <Layout
        ...
        postDesc={
          this.props.data.allSiteSettingEntitySite.edges[0].node
            .field_description
        }
      ...
      >
        <div className="c-tags u-push-top--inside--9x u-push-bottom--inside--4x">
          <div className="grid-container align-center u-push-bottom--inside--3x">
            <h1 className="c-tags__title cell medium-8 large-8 u-text--primary align-center grid-x">
              {tagTitle}
            </h1>
          </div>
                ...
                {articles.map(({ node }) => (
                  ...
                  >
                    <ArticleTeaser
                      ...
                      excerpt={
                        node.fields.markdownBody.childMarkdownRemark.excerpt
                      }
