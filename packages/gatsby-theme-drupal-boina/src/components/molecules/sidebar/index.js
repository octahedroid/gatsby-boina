...
const Sidebar = ({ showSidebar, hideSidebar }) => (
  <>
    <div
      className={`c-sidebar__cover ${
        showSidebar ? 'c-sidebar__cover--active' : ''
      }`}
      onClick={hideSidebar}
      role="button"
      aria-label="Close"
    ...
    />
    <div
      className={`c-sidebar grid-x align-top ${
        showSidebar ? 'c-sidebar--active' : ''
      }`}
    >
      ...
      <div className="c-sidebar__menu cell medium-12 grid-x align-center">
        <div className="cell small-10 medium-8">
          <ul className="o-list-bare u-push-bottom--6x">
            ...
            <li>
              <Link className="c-sidebar__link" to="/about">
                About
              </Link>
            </li>
          </ul>
